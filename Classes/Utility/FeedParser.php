...
*/
class Tx_Typo3mind_Utility_FeedParser
{
    ...
    public function parse ($url)
    {
        ...
        if ($URLContent) {
            ...
            foreach ($segments as $index => $data) {
                ...
                xml_parse($this->xmlParser, $data, $lastPiese) or die(
                sprintf("XML error: %s at line %d", xml_error_string(xml_get_error_code($this->xmlParser)),
